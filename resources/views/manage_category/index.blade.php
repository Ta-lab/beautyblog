...
<head>
    ...
    <title>BeautyeBooking | Manage Category </title>
                                ...
                                <table id="zero-config" class="table table-hover" style="width:100%">
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <a href="{{ route('category.edit',$category->id) }}"><i class="fa fa-pencil" title="Edit"></i> 
                                                <!--<a href="edit_category.html"><i class="fa fa-pencil" title="Edit"></i>--> 
                                            </td>
                                        </tr>
                                    @endforeach
                                </table>
