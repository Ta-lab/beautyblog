...
<head>
    ...
    <title>BeautyeBooking | View Blog </title>
    ...
    <link href="{{ asset('app-assets')}}/assets/css/users/user-profile.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="main-container" id="container">
        ...
        <!--  BEGIN CONTENT AREA  -->
        <div id="content" class="main-content driver-rating">
            <div class="layout-px-spacing">

                <div class="row layout-spacing">

                    <!-- Content -->
                    <div class="col-lg-6 col-md-5 col-sm-12 layout-top-spacing mx-auto">
                                ...
                                <div class="user-info-list">
                                    ...
                                    <div class="">
                                        <ul class="contacts-block list-unstyled ">
                                            ...
                                            <li class="contacts-block__item row">
                                               <div class="col-md-4"><span class="text-dark">Title:</span></div> 
                                               <div class="col-md-8">{{ $blog->blogtitle }}</div>
                                            </li>
                                            <li class="contacts-block__item row">
                                               <div class="col-md-4"><span class="text-dark">Date:</span></div> 
                                               <div class="col-md-8">{{ $blog->blogdate }}</div>
                                            </li>
                                            <li class="contacts-block__item row">
                                               <div class="col-md-4"><span class="text-dark">Category:</span></div> 
                                               <div class="col-md-8">{{ $blog->category }}</div>
                                            </li>
                                            <!--<li class="contacts-block__item row">
                                               <div class="col-md-4"><span class="text-dark">Status:</span></div> 
                                               <div class="col-md-8">Active</div>
                                            </li>-->
                                            <li class="contacts-block__item row">
                                               <div class="col-md-4"><span class="text-dark">Description:</span></div> 
