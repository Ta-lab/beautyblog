...
<head>
    ...
    <title>BeautyeBooking | Add Blog </title>
                ...
                <div class="row layout-top-spacing layout-spacing">
                    <div class="col-lg-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <form action="{{ route('blogs.store') }}" method="POST" class="col-md-8 mx-auto">
                                @csrf
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="" data-select2-id="22">
                                                <select name="category" class="form-control  basic">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="date" name="blogdate" class="form-control" placeholder="date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text area" name="description" class="form-control" placeholder="Description">
                                            </div>
                                        </div>
                                    </div>
