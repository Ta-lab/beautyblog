...
<head>
    ...
    <title>BeautyeBooking | Edit Category </title>
...
<body>
                ...
                <div class="row layout-top-spacing layout-spacing">
                    <div class="col-lg-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <form class="col-md-8 mx-auto" action="{{ route('category.update',$category->id) }}" method="POST">
                                @csrf
                                @method('PUT')
    ...
    <script src="{{ asset('app-assets')}}/plugins/table/datatable/datatables.js"></script>
    <script>
