...
<head>
    ...
    <title>BeautyeBooking | Manage Blog </title>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover" style="width:100%">
                                    ...
                                    @foreach ($blogs as $blog)
                                        ...
                                        <a href="{{ route('blogs.show',$blog->id) }}"><i class="fa fa-eye" title="View"></i>
                                            <!--<a href="view_blog.html"><i class="fa fa-eye" title="View"></i>--> 
                                        <a href="{{ route('blogs.edit',$blog->id) }}"><i class="fa fa-pencil" title="Edit"></i> 
